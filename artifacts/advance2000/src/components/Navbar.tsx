          ...
          <div className="grid grid-cols-3 gap-6">
            {CAPABILITIES.map((col) => {
              ...
              return (
                <div key={col.group}>
                  <div
                    className={`inline-flex items-center gap-2 px-2.5 py-1 rounded-lg ${col.bg} mb-3`}
                  >
                    <Icon
                      className={`w-3.5 h-3.5 ${col.accent}`}
                      strokeWidth={2}
                    />
                    <span
                      className={`${col.accent} text-xs font-bold tracking-wide uppercase`}
                    >
                      {col.group}
                    </span>
                  </div>
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        >
          <a
            href="https://myportal.advance2000.com/login/"
            target="_blank"
            rel="noopener noreferrer"
            className="text-white/80 hover:text-white border border-white/20 hover:border-white/40 px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 backdrop-blur-sm inline-block"
          >
            Client Login
          </a>
      ...
      <AnimatePresence>
        {menuOpen && (
          ...
          >
            ...
            <div className="mb-2">
              <p className="text-white/90 text-sm font-semibold py-2">
                What We Do
              </p>
